...
const Login = () => {
    ...
    // Redirect to dashboard when session becomes available.
    // Use useEffect to avoid updating router during render.
    useEffect(() => {
        if (session) {
    ...
    return (
        <div className='text-white font-bold container mx-auto'>
            <h1 className='text-white py-6 text-2xl font-bold text-center'>Login to Get your fans to support you</h1>


            <div className="flex flex-col gap-2  justify-center items-center w-full  p-16">


                <button onClick={() => { signIn("google") }}
                    className="flex items-center w-66  border bg-slate-50 text-black border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink"
